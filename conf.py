...
latex_documents = [
  (master_doc, 'Numeric.tex', 'Numeric Documentation',
   'Numeric', 'manual'),
]
...
man_pages = [
    (master_doc, 'Numeric', 'Numeric Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Numeric', 'Numeric Documentation',
   author, 'Numeric', 'One line description of project.',
   'Miscellaneous'),
]
